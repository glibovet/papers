...
public interface IScheduler {
     ...
     */
    void start(@NotNull ICrawler.ICallback crawlCallback, @NotNull IPageIndexer.ICallback indexCallback,
     ...
     * @param startUrls     start urls to process
     */
    void start(@NotNull ICrawler.ICallback crawlCallback, @NotNull Collection<Object> handlers,
